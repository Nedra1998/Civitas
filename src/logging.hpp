#ifndef civitas_LOGGING_HPP_
#define civitas_LOGGING_HPP_
...
void callback(int level, const char *text, va_list args);
bool setup();
} // namespace civitas::logging
